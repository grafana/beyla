...
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------- | ------- |
| `sources`<p>`BEYLA_NAME_RESOLVER_SOURCES`</p> | A comma separated list of metadata sources to use for name resolution. More details below.                | list of strings    | ["k8s", "rdns"] |
