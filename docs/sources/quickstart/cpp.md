...
[simple C++ HTTP service](https://raw.githubusercontent.com/grafana/beyla/main/examples/quickstart/cpp).
...
* `svc=[{quickstart  generic lima-ubuntu-lts-5074}]`: `quickstart` service, using the
  generic kernel-based instrumented, with an automatically created service instance name
