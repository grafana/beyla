...
## 1. Run your instrumentable Python service

You can use any service of your own. For testing purposes, you can also download and run this
[simple Python HTTP service](https://github.com/grafana/beyla/tree/main/examples/quickstart/python).
...
report the name of the process executable: `python3`.
