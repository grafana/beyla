...
func Fixture() *TracesQuery {
	...
	err := json.Unmarshal([]byte(`{"data":[{"traceID":"eae56fbbec9505c102e8aabfc6b5c481","spans":[{"traceID":"eae56fbbec9505c102e8aabfc`+
		...
		`:[{"key":"otel.scope.name","type":"string","value":"github.com/grafana/beyla"},{"key":"span.kind"`+
		...
		`1eef766536d58ec8"}],"startTime":1686641491455316,"duration":476,"tags":[{"key":"otel.scope.name","type":"string`+
		...
		`artTime":1686641491452470,"duration":3322,"tags":[{"key":"otel.scope.name","type":"string","value":"github.com/grafana/beyla"`+
		...
		`a","references":[],"startTime":1686641494868532,"duration":1108,"tags":[{"key":"otel.scope.name","type":"string`+
		...
		`6641494869530,"duration":109,"tags":[{"key":"otel.scope.name","type":"string","value":"github.com/grafana/ebpf-`+
		...
		`otel.scope.name","type":"string","value":"github.com/grafana/beyla"},{"key":"span.kind","type":"s`+
