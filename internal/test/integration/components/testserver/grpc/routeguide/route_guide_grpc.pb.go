...
type RouteGuideClient interface {
	...
	// Just a dummy method for debug
	Debug(ctx context.Context, in *DebugReq, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *routeGuideClient) Debug(ctx context.Context, in *DebugReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/routeguide.RouteGuide/Debug", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RouteGuideServer interface {
	...
	// Just a dummy method for debug
	Debug(context.Context, *DebugReq) (*Empty, error)
...
func (UnimplementedRouteGuideServer) Debug(context.Context, *DebugReq) (*Empty, error) {
...
func _RouteGuide_Debug_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(RouteGuideServer).Debug(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var RouteGuide_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Debug",
			Handler:    _RouteGuide_Debug_Handler,
		},
	},
