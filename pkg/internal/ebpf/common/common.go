...
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -target amd64,arm64 -type http_request_trace -type sql_request_trace -type http_info_t -type connection_info_t bpf ../../../../bpf/http_trace.c -- -I../../../../bpf/headers
...
func RegisterActiveService(pid uint32, svc svc.ID) {
	fmt.Printf("name=%s lang=%s", svc.Name, svc.SDKLanguage)
