...
type (
	HTTPRequestTrace    ebpfcommon.BpfHttpRequestTrace
	SQLRequestTrace     ebpfcommon.BpfSqlRequestTrace
	BPFHTTPInfo         ebpfcommon.BpfHttpInfoT
	BPFConnInfo         ebpfcommon.BpfConnectionInfoT
	TCPRequestInfo      ebpfcommon.BpfTcpReqT
	GoSaramaClientInfo  ebpfcommon.BpfKafkaClientReqT
	GoRedisClientInfo   ebpfcommon.BpfRedisClientReqT
	GoKafkaGoClientInfo ebpfcommon.BpfKafkaGoReqT
)
