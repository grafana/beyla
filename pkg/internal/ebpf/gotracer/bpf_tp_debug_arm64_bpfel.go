...
type bpf_tp_debugOffTableT struct{ Table [56]uint64 }
...
type bpf_tp_debugStreamKeyT struct {
	ConnPtr  uint64
	StreamId uint32
	Pad      uint32
}
...
type bpf_tp_debugTransportNewClientInvocationT struct {
	Inv   bpf_tp_debugGrpcClientFuncInvocationT
	S_key bpf_tp_debugStreamKeyT
}
...
type bpf_tp_debugSpecs struct {
	...
	bpf_tp_debugVariableSpecs
}

// bpf_tp_debugProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// bpf_tp_debugVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpf_tp_debugVariableSpecs struct {
...
// bpf_tp_debugVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadBpf_tp_debugObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpf_tp_debugVariables struct {
