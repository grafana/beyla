...
type bpf_tpOffTableT struct{ Table [56]uint64 }
...
type bpf_tpTransportNewClientInvocationT struct {
	Inv   bpf_tpGrpcClientFuncInvocationT
	S_key bpf_tpStreamKeyT
}
