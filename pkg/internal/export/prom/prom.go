...
func newReporter(ctx context.Context, cfg *PrometheusConfig, ctxInfo *global.ContextInfo) *metricsReporter {
	...
	mr := &metricsReporter{
		...
		httpDuration: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			NativeHistogramBucketFactor:     otel.DefaultHistogramBucketFactor,
			NativeHistogramMaxBucketNumber:  otel.DefaultHistogramMaxBucketNumber,
			NativeHistogramMinResetDuration: otel.DefaultHistogramMinResetDuration,
