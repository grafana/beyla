...
func SpanOTELGetters(name attr.Name) (attributes.Getter[*Span, attribute.KeyValue], bool) {
	...
	case attr.ClientNamespace:
		getter = func(s *Span) attribute.KeyValue {
			if s.IsClientSpan() {
				return ClientNamespaceMetric(s.ServiceID.UID.Namespace)
			}
	...
	case attr.ServerNamespace:
		getter = func(s *Span) attribute.KeyValue {
			...
			return ServerNamespaceMetric(s.ServiceID.UID.Namespace)
		}
	case attr.Service:
		getter = func(s *Span) attribute.KeyValue { return ServiceMetric(s.ServiceID.UID.Name) }
	case attr.ServiceInstanceID:
		getter = func(s *Span) attribute.KeyValue { return semconv.ServiceInstanceID(string(s.ServiceID.UID.Instance)) }
	case attr.ServiceName:
		getter = func(s *Span) attribute.KeyValue { return semconv.ServiceName(s.ServiceID.UID.Name) }
	case attr.ServiceNamespace:
		getter = func(s *Span) attribute.KeyValue { return semconv.ServiceNamespace(s.ServiceID.UID.Namespace) }
	case attr.SpanKind:
...
func SpanPromGetters(attrName attr.Name) (attributes.Getter[*Span, string], bool) {
	...
	case attr.ServiceInstanceID:
		getter = func(s *Span) string { return string(s.ServiceID.UID.Instance) }
	...
	case attr.ServiceName:
		getter = func(s *Span) string { return s.ServiceID.UID.Name }
	case attr.ServiceNamespace:
		getter = func(s *Span) string { return s.ServiceID.UID.Namespace }
	default:
