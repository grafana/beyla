...
func (b *PodBouncer) RestartDeployment(ctx context.Context, namespace, deploymentName, workloadKind, language string) error {
	...
	if b.metrics != nil {
		b.metrics.RecordRestart(namespace, workloadKind, deploymentName, language)
	}
