# -*- encoding: utf-8 -*-
# stub: opentelemetry-api 1.9.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-api/v1.9.0/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-api/v1.9.0", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/api" } if s.respond_to? :metadata=
