# -*- encoding: utf-8 -*-
# stub: opentelemetry-metrics-sdk 0.13.1 ruby lib

Gem::Specification.new do |s|
  s.name = "opentelemetry-metrics-sdk".freeze
  s.version = "0.13.1".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-metrics-sdk/v0.13.1/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-metrics-sdk/v0.13.1", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/metrics_sdk" } if s.respond_to? :metadata=
