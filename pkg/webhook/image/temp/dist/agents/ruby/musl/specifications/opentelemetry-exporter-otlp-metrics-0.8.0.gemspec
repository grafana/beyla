# -*- encoding: utf-8 -*-
# stub: opentelemetry-exporter-otlp-metrics 0.8.0 ruby lib

Gem::Specification.new do |s|
  s.name = "opentelemetry-exporter-otlp-metrics".freeze
  s.version = "0.8.0".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-exporter-otlp-metrics/v0.8.0/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-exporter-otlp-metrics/v0.8.0", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/exporter/otlp-metrics" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["OpenTelemetry Authors".freeze]
  s.date = "1980-01-02"
  s.description = "OTLP metrics exporter for the OpenTelemetry framework".freeze
  ...
  s.summary = "OTLP metrics exporter for the OpenTelemetry framework".freeze
  ...
  s.add_runtime_dependency(%q<google-protobuf>.freeze, [">= 3.18".freeze, "< 5.0".freeze])
  ...
  s.add_runtime_dependency(%q<opentelemetry-metrics-api>.freeze, ["~> 0.2".freeze])
  s.add_runtime_dependency(%q<opentelemetry-metrics-sdk>.freeze, ["~> 0.5".freeze])
