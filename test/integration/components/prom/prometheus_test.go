...
beyla_network_flow_bytes_total{beyla_ip="1.2.3.4",direction="ingress",dst_port="1011",iface="fakeiface",src_port="789",transport="TCP"} 123.3
beyla_network_flow_bytes_total{beyla_ip="1.2.3.4",direction="ingress",dst_port="1415",iface="fakeiface",src_port="1213",transport="TCP"} 1
