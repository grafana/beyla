...
var file_proto_informer_proto_rawDesc = []byte{
	...
	0x65, 0x2a, 0x32, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b,
	...
	0x54, 0x45, 0x44, 0x10, 0x02, 0x32, 0x50, 0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x09, 0x53,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x1a, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x72,
	0x6d, 0x65, 0x72, 0x2e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x1a, 0x0f, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x65, 0x72, 0x2e,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x69, 0x6e, 0x66,
...
var file_proto_informer_proto_goTypes = []interface{}{
...
func file_proto_informer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_informer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_informer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_informer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_informer_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_informer_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_informer_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_informer_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
