...
* Versioning of this project will be idiomatic of a Go project using [Go
  ...
  * [Semantic import
    ...
    * If a module is version `v2` or higher, the major version of the module
      ...
      `go.mod` files (e.g., `module github.com/grafana/opentelemetry-go/v2`, `require
      github.com/grafana/opentelemetry-go/v2 v2.0.1`) and in the package import path
      (e.g., `import "github.com/grafana/opentelemetry-go/v2/trace"`). This includes the
      paths used in `go get` commands (e.g., `go get
      github.com/grafana/opentelemetry-go/v2@v2.0.1`.  Note there is both a `/v2` and a
