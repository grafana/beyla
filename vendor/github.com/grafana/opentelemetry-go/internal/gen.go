...
package internal // import "github.com/grafana/opentelemetry-go/internal"
...
//go:generate gotmpl --body=./shared/internaltest/harness.go.tmpl "--data={\"matchersImportPath\": \"github.com/grafana/opentelemetry-go/internal/matchers\"}" --out=internaltest/harness.go
