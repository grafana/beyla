...
func (mr *ManualReader) temporality(kind InstrumentKind) sdkmetricdata.Temporality {
	return mr.temporalitySelector(kind)
}

// aggregation returns what Aggregation to use for kind.
func (mr *ManualReader) aggregation(kind InstrumentKind) sdkmetric.Aggregation { // nolint:revive  // import-shadow for method scoped by type.
...
type temporalitySelectorOption struct {
	selector func(instrument InstrumentKind) sdkmetricdata.Temporality
}
