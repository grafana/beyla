...
type BpfJvmGcHeapSummaryEvent struct {
	_          structs.HostLayout
	Type       uint8
	Pad        [7]uint8
	Timestamp  uint64
...
type BpfJvmHeapSummaryKey struct {
	_          structs.HostLayout
	Pid        uint32
	GcWhenType uint32
}
...
type BpfProgramSpecs struct {
	...
	ObiUprobeReportGcHeapSummary                       *ebpf.ProgramSpec `ebpf:"obi_uprobe_report_gc_heap_summary"`
...
type BpfMapSpecs struct {
	...
	JvmHeapSummarySamples      *ebpf.MapSpec `ebpf:"jvm_heap_summary_samples"`
...
type BpfVariableSpecs struct {
	...
	JvmGcHeapSummaryEvent    *ebpf.VariableSpec `ebpf:"_jvm_gc_heap_summary_event"`
...
type BpfMaps struct {
	...
	JvmHeapSummarySamples      *ebpf.Map `ebpf:"jvm_heap_summary_samples"`
...
type BpfVariables struct {
	...
	JvmGcHeapSummaryEvent    *ebpf.Variable `ebpf:"_jvm_gc_heap_summary_event"`
...
type BpfPrograms struct {
	...
	ObiUprobeReportGcHeapSummary                       *ebpf.Program `ebpf:"obi_uprobe_report_gc_heap_summary"`
...
func (p *BpfPrograms) Close() error {
	return _BpfClose(
		...
		p.ObiUprobeReportGcHeapSummary,
		p.ObiUprobeSslRead,
