...
type BpfGoAutoActivationAttemptKeyT struct {
	_          structs.HostLayout
	Generation uint64
	Pid        uint32
	Attempt    uint8
...
type BpfGoAutoSpanStateT struct {
	_          structs.HostLayout
	PrevTp     BpfTpInfoT
	ChildTp    BpfTpInfoT
	Goroutine  uint64
...
type BpfGoLargeBufferKeyT struct {
	_        structs.HostLayout
...
type BpfGoLargeBufferReqT struct {
	_         structs.HostLayout
	Tp        BpfTpInfoT
	EventType uint8
	Pad       [7]uint8
...
const (
	BpfMapActiveGoAutoSpans                                       = "active_go_auto_spans"
	...
	BpfMapGoAutoActivationAttempts                                = "go_auto_activation_attempts"
	BpfMapGoAutoSpanEventStorage                                  = "go_auto_span_event_storage"
	BpfMapGoAutoTargets                                           = "go_auto_targets"
	BpfMapGoExecutableIdentityRequests                            = "go_executable_identity_requests"
	BpfMapGoGrpcClientConns                                       = "go_grpc_client_conns"
	BpfMapGoH2FieldStorage                                        = "go_h2_field_storage"
	BpfMapGoH2OwnedStreams                                        = "go_h2_owned_streams"
	BpfMapGoH2ReadbackStorage                                     = "go_h2_readback_storage"
	BpfMapGoHttp2ClientConnections                                = "go_http2_client_connections"
	...
	BpfMapGoPersistConnInfo                                       = "go_persist_conn_info"
	BpfMapGoPersistConnRequest                                    = "go_persist_conn_request"
	...
	BpfMapHttp2HeaderObservations                                 = "http2_header_observations"
	...
	BpfMapOngoingLargeBuffers                                     = "ongoing_large_buffers"
	...
	BpfMapOngoingServerBufr                                       = "ongoing_server_bufr"
	...
	BpfMapOngoingWriteSubsets                                     = "ongoing_write_subsets"
	...
	BpfMapRoundTripClientDataStorage                              = "round_trip_client_data_storage"
	BpfMapServeHttpInvStorage                                     = "serve_http_inv_storage"
	...
	BpfProgObiCaptureGoExecutableIdentity                         = "obi_capture_go_executable_identity"
	...
	BpfProgObiUprobeAutoSdkContextWithValue                       = "obi_uprobe_auto_sdk_context_WithValue"
	BpfProgObiUprobeAutoSdkSpanEnded                              = "obi_uprobe_auto_sdk_span_Ended"
	BpfProgObiUprobeAutoSdkTracerStart                            = "obi_uprobe_auto_sdk_tracer_Start"
	...
	BpfProgObiUprobeGoRuntimeGcGoal                               = "obi_uprobe_go_runtime_gc_goal"
	BpfProgObiUprobeGoRuntimeMetrics                              = "obi_uprobe_go_runtime_metrics"
	...
	BpfProgObiUprobePersistConnWriterWrite                        = "obi_uprobe_persistConnWriterWrite"
	...
	BpfProgObiUprobeTracerNewSpan                                 = "obi_uprobe_tracer_NewSpan"
	...
	BpfProgObiUprobeWriteSubsetReturns                            = "obi_uprobe_writeSubset_returns"
	BpfProgObiUprobeWriteSubsetReturnsLegacy                      = "obi_uprobe_writeSubset_returns_legacy"
...
type BpfProgramSpecs struct {
	ObiCaptureGoExecutableIdentity                         *ebpf.ProgramSpec `ebpf:"obi_capture_go_executable_identity"`
	...
	ObiUprobeAutoSdkContextWithValue                       *ebpf.ProgramSpec `ebpf:"obi_uprobe_auto_sdk_context_WithValue"`
	ObiUprobeAutoSdkSpanEnded                              *ebpf.ProgramSpec `ebpf:"obi_uprobe_auto_sdk_span_Ended"`
	ObiUprobeAutoSdkTracerStart                            *ebpf.ProgramSpec `ebpf:"obi_uprobe_auto_sdk_tracer_Start"`
	...
	ObiUprobeGoRuntimeGcGoal                               *ebpf.ProgramSpec `ebpf:"obi_uprobe_go_runtime_gc_goal"`
	ObiUprobeGoRuntimeMetrics                              *ebpf.ProgramSpec `ebpf:"obi_uprobe_go_runtime_metrics"`
	...
	ObiUprobePersistConnWriterWrite                        *ebpf.ProgramSpec `ebpf:"obi_uprobe_persistConnWriterWrite"`
	...
	ObiUprobeTracerNewSpan                                 *ebpf.ProgramSpec `ebpf:"obi_uprobe_tracer_NewSpan"`
	...
	ObiUprobeWriteSubsetReturns                            *ebpf.ProgramSpec `ebpf:"obi_uprobe_writeSubset_returns"`
	ObiUprobeWriteSubsetReturnsLegacy                      *ebpf.ProgramSpec `ebpf:"obi_uprobe_writeSubset_returns_legacy"`
...
type BpfMapSpecs struct {
	ActiveGoAutoSpans              *ebpf.MapSpec `ebpf:"active_go_auto_spans"`
	...
	GoAutoActivationAttempts       *ebpf.MapSpec `ebpf:"go_auto_activation_attempts"`
	GoAutoSpanEventStorage         *ebpf.MapSpec `ebpf:"go_auto_span_event_storage"`
	GoAutoTargets                  *ebpf.MapSpec `ebpf:"go_auto_targets"`
	GoExecutableIdentityRequests   *ebpf.MapSpec `ebpf:"go_executable_identity_requests"`
	GoGrpcClientConns              *ebpf.MapSpec `ebpf:"go_grpc_client_conns"`
	GoH2FieldStorage               *ebpf.MapSpec `ebpf:"go_h2_field_storage"`
	GoH2OwnedStreams               *ebpf.MapSpec `ebpf:"go_h2_owned_streams"`
	GoH2ReadbackStorage            *ebpf.MapSpec `ebpf:"go_h2_readback_storage"`
	GoHttp2ClientConnections       *ebpf.MapSpec `ebpf:"go_http2_client_connections"`
	...
	GoPersistConnInfo              *ebpf.MapSpec `ebpf:"go_persist_conn_info"`
	GoPersistConnRequest           *ebpf.MapSpec `ebpf:"go_persist_conn_request"`
	...
	Http2HeaderObservations        *ebpf.MapSpec `ebpf:"http2_header_observations"`
	...
	OngoingLargeBuffers            *ebpf.MapSpec `ebpf:"ongoing_large_buffers"`
	...
	OngoingServerBufr              *ebpf.MapSpec `ebpf:"ongoing_server_bufr"`
	...
	RoundTripClientDataStorage     *ebpf.MapSpec `ebpf:"round_trip_client_data_storage"`
	ServeHttpInvStorage            *ebpf.MapSpec `ebpf:"serve_http_inv_storage"`
...
// It can be passed to LoadBpfObjects or ebpf.CollectionSpec.LoadAndAssign.
type BpfMaps struct {
	ActiveGoAutoSpans              *ebpf.Map `ebpf:"active_go_auto_spans"`
	...
	GoAutoActivationAttempts       *ebpf.Map `ebpf:"go_auto_activation_attempts"`
	GoAutoSpanEventStorage         *ebpf.Map `ebpf:"go_auto_span_event_storage"`
	GoAutoTargets                  *ebpf.Map `ebpf:"go_auto_targets"`
	GoExecutableIdentityRequests   *ebpf.Map `ebpf:"go_executable_identity_requests"`
	GoGrpcClientConns              *ebpf.Map `ebpf:"go_grpc_client_conns"`
	GoH2FieldStorage               *ebpf.Map `ebpf:"go_h2_field_storage"`
	GoH2OwnedStreams               *ebpf.Map `ebpf:"go_h2_owned_streams"`
	GoH2ReadbackStorage            *ebpf.Map `ebpf:"go_h2_readback_storage"`
	GoHttp2ClientConnections       *ebpf.Map `ebpf:"go_http2_client_connections"`
	...
	GoPersistConnInfo              *ebpf.Map `ebpf:"go_persist_conn_info"`
	GoPersistConnRequest           *ebpf.Map `ebpf:"go_persist_conn_request"`
	...
	Http2HeaderObservations        *ebpf.Map `ebpf:"http2_header_observations"`
	...
	OngoingLargeBuffers            *ebpf.Map `ebpf:"ongoing_large_buffers"`
	...
	OngoingServerBufr              *ebpf.Map `ebpf:"ongoing_server_bufr"`
	...
	RoundTripClientDataStorage     *ebpf.Map `ebpf:"round_trip_client_data_storage"`
	ServeHttpInvStorage            *ebpf.Map `ebpf:"serve_http_inv_storage"`
...
func (m *BpfMaps) Close() error {
	return _BpfClose(
		...
		m.GoAutoActivationAttempts,
		m.GoAutoSpanEventStorage,
		m.GoAutoTargets,
		m.GoExecutableIdentityRequests,
		m.GoGrpcClientConns,
		m.GoH2FieldStorage,
		m.GoH2OwnedStreams,
		m.GoH2ReadbackStorage,
		m.GoHttp2ClientConnections,
		m.GoOffsetsMap,
		m.GoOngoingHttp,
		m.GoOngoingHttpClientRequests,
		m.GoPersistConnInfo,
		m.GoPersistConnRequest,
		...
		m.RedisWrites,
		m.ReqClientStorage,
		m.RoundTripClientDataStorage,
		m.ServeHttpInvStorage,
		m.ServerTraces,
		m.ServerTracesAux,
		m.SpanMem,
		m.SpanNames,
...
type BpfPrograms struct {
	ObiCaptureGoExecutableIdentity                         *ebpf.Program `ebpf:"obi_capture_go_executable_identity"`
	...
	ObiUprobeAutoSdkContextWithValue                       *ebpf.Program `ebpf:"obi_uprobe_auto_sdk_context_WithValue"`
	ObiUprobeAutoSdkSpanEnded                              *ebpf.Program `ebpf:"obi_uprobe_auto_sdk_span_Ended"`
	ObiUprobeAutoSdkTracerStart                            *ebpf.Program `ebpf:"obi_uprobe_auto_sdk_tracer_Start"`
	...
	ObiUprobeGoRuntimeGcGoal                               *ebpf.Program `ebpf:"obi_uprobe_go_runtime_gc_goal"`
	ObiUprobeGoRuntimeMetrics                              *ebpf.Program `ebpf:"obi_uprobe_go_runtime_metrics"`
	...
	ObiUprobePersistConnWriterWrite                        *ebpf.Program `ebpf:"obi_uprobe_persistConnWriterWrite"`
	...
	ObiUprobeTracerNewSpan                                 *ebpf.Program `ebpf:"obi_uprobe_tracer_NewSpan"`
	...
	ObiUprobeWriteSubsetReturns                            *ebpf.Program `ebpf:"obi_uprobe_writeSubset_returns"`
	ObiUprobeWriteSubsetReturnsLegacy                      *ebpf.Program `ebpf:"obi_uprobe_writeSubset_returns_legacy"`
...
func (p *BpfPrograms) Close() error {
	return _BpfClose(
		p.ObiCaptureGoExecutableIdentity,
		...
		p.ObiUprobeAutoSdkContextWithValue,
		p.ObiUprobeAutoSdkSpanEnded,
		p.ObiUprobeAutoSdkTracerStart,
		...
		p.ObiUprobeGoRuntimeGcGoal,
		p.ObiUprobeGoRuntimeMetrics,
		...
		p.ObiUprobePersistConnWriterWrite,
		p.ObiUprobePgxExec,
		p.ObiUprobePgxQuery,
		...
		p.ObiUprobeWriteSubsetReturns,
		p.ObiUprobeWriteSubsetReturnsLegacy,
