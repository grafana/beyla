...
type StatsProgramSpecs struct {
	...
	ObiTracepointInetSockSetState *ebpf.ProgramSpec `ebpf:"obi_tracepoint_inet_sock_set_state"`
}
...
type StatsPrograms struct {
	...
	ObiTracepointInetSockSetState *ebpf.Program `ebpf:"obi_tracepoint_inet_sock_set_state"`
}

func (p *StatsPrograms) Close() error {
	return _StatsClose(
		p.ObiKprobeTcpCloseSrtt,
		p.ObiTracepointInetSockSetState,
	)
}
